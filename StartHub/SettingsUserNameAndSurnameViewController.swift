//
//  SettingsUserNameAndSurnameViewController.swift
//  StartHub
//
...
class SettingsUserNameAndSurnameViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        postedBy.getDocument { document, error in
            if let document = document, document.exists {
                ...
                let name = userData?["userName"] as? String ?? "olmadı"
        ...
        postedBy.getDocument { document, error in
            if let document = document, document.exists {
                ...
                let updatedUsername: [String: Any] = [
                            "userName": self.NEWNameText.text!
                        ]
                ...
                self.makeAlert(title: "SUCCES", message: "Name Changed")
